...
`BOT_TOKEN`, `CHANNEL_ID`, `ADMIN_KEY`, `SECRET_KEY`.

The gallery grid uses small cached thumbnails. The original Telegram document is
still used for the lightbox and downloads.

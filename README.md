...
### v16 bandwidth architecture
The normal admin photo uploader sends originals/thumbnails/previews directly through the Cloudflare Worker to Telegram. The small JSON database backup is also forwarded through the Worker and is coalesced during rapid saves, reducing Render service-initiated bandwidth.

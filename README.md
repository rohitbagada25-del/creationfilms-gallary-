...
- New uploads store three Telegram documents: untouched ORIGINAL, 1280px THUMB, and compressed 2000px PREVIEW.
- Gallery grid uses THUMB.
- Lightbox uses PREVIEW.
- Download uses ORIGINAL.
- New galleries should be created after deploying this version for a clean start.
